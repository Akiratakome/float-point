...
void setup_riemann(GridView<Real, EulerNVars> grid, Real gamma, Real x0,
...
template <typename Real>
void setup_sod(GridView<Real, EulerNVars> grid, Real gamma) {
...
template <typename Real>
void setup_toro2(GridView<Real, EulerNVars> grid, Real gamma) {
    setup_riemann(grid, gamma, Real(0.5),
...
template <typename Real>
void setup_toro3(GridView<Real, EulerNVars> grid, Real gamma) {
    setup_riemann(grid, gamma, Real(0.5),
...
template <typename Real>
void setup_toro4(GridView<Real, EulerNVars> grid, Real gamma) {
    setup_riemann(grid, gamma, Real(0.5),
...
// Domain [0,1], x0=0.5, t_end=0.035
template <typename Real>
void setup_toro5(GridView<Real, EulerNVars> grid, Real gamma) {
    setup_riemann(grid, gamma, Real(0.5),
...
template <typename Real>
void setup_stationary_contact(GridView<Real, EulerNVars> grid, Real gamma) {
    setup_riemann(grid, gamma, Real(0.5),
