...
| OT/KH 512^2 consolidation | `deferred` | Authoritative current inputs: `experiments/week13/orszag_tang/paper_summary.md` and `experiments/week13/kelvin_helmholtz/paper_summary.md`; authoritative completion path: `docs/superpowers/specs/2026-07-21-week15-16-completion-design.md` §2.5. The required OT 512^2 reference consolidation and KH 256^2-versus-512^2 gate are not complete. | Two-resolution sensitivity can be assessed only after the complete 256^2/512^2 packages exist. | Asymptotic convergence from two resolutions. | None. | Tracked: the Week 13 summaries and existing figures; local ignored/transient: any generated 512^2 run configs, logs, metadata, grids, and comparison outputs; deferred: no completed consolidated summary/figure package. |
